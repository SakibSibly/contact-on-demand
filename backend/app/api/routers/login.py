...
from app.models import User, UserBase, UserBaseWithContact, UserCreate, UserLogin, TokenResponse, TokenRefresh, TokenBlacklist
...
@router.get("/users/me", response_model=UserBaseWithContact)
